 ...
 * <p>
 * This class accesses the {@link UserDbDTO} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public UserResource(UserService userService, UserRepository userRepository, MailProvider mailService, UserSearchRepository userSearchRepository) {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.SCHOOLME_ADMIN + "\")")
    public ResponseEntity<UserDbDTO> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            UserDbDTO newUser = userService.createUser(userDTO);
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        Optional<UserDbDTO> existingUser = userRepository.findOneByEmailIgnoreCase(userDTO.getEmail());
    ...
    public List<UserDbDTO> search(@PathVariable String query) {
