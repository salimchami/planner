...
public class SubjectDbDTO implements Comparable<SubjectDbDTO>, Serializable {
    ...
    private List<PreferredPartsOfDaysDbDTO> preferredPartsOfDaysInTimetables;
    ...
    public List<PreferredPartsOfDaysDbDTO> getPreferredPartsOfDaysInTimetables() {
        return preferredPartsOfDaysInTimetables;
    }

    public void setPreferredPartsOfDaysInTimetables(List<PreferredPartsOfDaysDbDTO> preferredPartsOfDaysInTimetables) {
