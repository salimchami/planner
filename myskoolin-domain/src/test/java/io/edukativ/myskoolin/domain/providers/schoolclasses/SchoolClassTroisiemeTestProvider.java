...
public final class SchoolClassTroisiemeTestProvider {
    ...
    public static SchoolClass generate(String schoolClassId, Grade schoolClassGrade, List<Teacher> allTeachers, String schoolClassName) {
        List<TeachersBySubject> teachersBySubjects = Arrays.asList(
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_TECHNOLOGIE_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_TECHNOLOGIE_1_ID,
                                GlobalTestProvider.TEACHER_TECHNOLOGIE_2_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_FRANCAIS_ID,
                        Arrays.asList(
                ...
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_SPORT_ID,
                        Arrays.asList(
                ...
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_ANGLAIS_ID,
                        Arrays.asList(
                ...
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_ALLEMAND_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_ALLEMAND_1_ID,
                                GlobalTestProvider.TEACHER_ALLEMAND_2_ID,
                                GlobalTestProvider.TEACHER_ALLEMAND_3_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_DESSIN_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_DESSIN_1_ID,
                                GlobalTestProvider.TEACHER_DESSIN_2_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_HISTGEO_GEO_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_HISTGEO_1_GEO_ID,
                                GlobalTestProvider.TEACHER_HISTGEO_2_GEO_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_MATHS_ID,
                        Arrays.asList(
                ...
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_EDUCCIV_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_EDUCCIV_1_ID,
                                GlobalTestProvider.TEACHER_EDUCCIV_2_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_SVT_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_SVT_1_ID,
                                GlobalTestProvider.TEACHER_SVT_2_ID,
                                GlobalTestProvider.TEACHER_SVT_3_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_PHYSIQUE_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_PHYSIQUE_1_ID,
                                GlobalTestProvider.TEACHER_PHYSIQUE_2_ID,
                                GlobalTestProvider.TEACHER_PHYSIQUE_3_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_MUSIQUE_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_MUSIQUE_1_ID,
                                GlobalTestProvider.TEACHER_MUSIQUE_2_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_MATHS_EPI_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_MATHS_1_ID,
                                GlobalTestProvider.TEACHER_MATHS_2_ID,
                                GlobalTestProvider.TEACHER_MATHS_3_ID,
                ...
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_FRANCAIS_EPI_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_FRANCAIS_1_ID,
                                GlobalTestProvider.TEACHER_FRANCAIS_2_ID,
                                GlobalTestProvider.TEACHER_FRANCAIS_3_ID,
                ...
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_LATIN_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_LATIN_1_ID,
                                GlobalTestProvider.TEACHER_LATIN_2_ID
                        )),
                new TeachersBySubject(GlobalTestProvider.Subjects.Troisieme.SUBJECT_TROISIEME_SCIENCES_EPI_ID,
                        Arrays.asList(
                                GlobalTestProvider.TEACHER_PHYSIQUE_1_ID,
                                GlobalTestProvider.TEACHER_PHYSIQUE_2_ID,
                                GlobalTestProvider.TEACHER_PHYSIQUE_3_ID,
