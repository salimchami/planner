...
//    }
//
//    public static List<SchoolClass> generateCinquieme(List<Teacher> allTeachers, Grade grade, Integer nb, List<Subject> subjects) {
//        List<SchoolClass> schoolClasses = new ArrayList<>();
//        for (int i = 1; i <= nb; i++) {
//            schoolClasses.add(SchoolClassCinquiemeTestProvider.generate("Cinquieme" + i, grade, allTeachers, "Cinquième " + i, subjects));
//        }
//        return schoolClasses;
//    }
//
...
//    }
//
//    public static List<SchoolClass> schoolClasses(List<Teacher> teachers, List<Subject> subjects, int sixiemes, int cinquiemes, int quatriemes, int troisiemes) {
//        return Stream.of(
//                SchoolClassTestProvider.generateSixieme(teachers, GradeTestProvider.sixiemeGrade, sixiemes),
//                SchoolClassTestProvider.generateCinquieme(teachers, GradeTestProvider.cinquiemeGrade, cinquiemes, subjects),
...
//        return schoolClasses(Collections.emptyList(), Collections.emptyList(), sixiemes, cinquiemes, quatriemes, troisiemes);
//    }
//
...
//        final List<SchoolClass> schoolClasses = schoolClasses(Collections.emptyList(), Collections.emptyList(), sixiemes, cinquiemes, quatriemes, troisiemes);
